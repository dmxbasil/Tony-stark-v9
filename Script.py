class script(object):
    START_TXT = """👋 𝙷𝙴𝙻𝙾 {},
ᴍy ɴᴀᴍᴇ ɪꜱ <a href=https://t.me/{}>{}</a>,\n ɪᴀᴍ ᴀ ᴩᴜʙʟɪᴄ ʙᴏᴛ ꜱᴏ yᴏᴜ ᴄᴀɴ ᴀᴅᴅ ᴍᴇ ᴛᴏ yᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴩ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀꜱ ᴀᴅᴍɪɴ ..."""
    HELP_TXT = """𝙷𝙴𝚈 {}
ʜᴇʟᴩ ᴄᴏᴍᴍᴀɴᴅꜱ """
    ABOUT_TXT = """✯ ᴍy ɴᴀᴍᴇ : {}
⌨︎ ᴄʀᴇᴀᴛᴏʀ ➪ <a href=https://t.me/basildmx>𝑩𝒂𝒔𝒊𝒍 𝑫𝒎𝒙</a>
❍ ᴜᴩᴅᴀᴛᴇꜱ ➪ <a href=https://t.me/dmx_bots>𝑫𝑴𝑿 𝑩𝒐𝒕𝒔</a>
❍ ʟɪʙʀᴀʀy ➪ 𝑷𝒚𝒓𝒐𝒈𝒓𝒂𝒎
❍ ʟᴀɴɢ ➪ 𝑷𝒚𝒕𝒉𝒐𝒏 3
❍ ᴠᴇʀꜱɪᴏɴ 9
❍ ꜱᴛᴀᴛᴜꜱ ➪ 𝑷𝒖𝒃𝒍𝒊𝒄
